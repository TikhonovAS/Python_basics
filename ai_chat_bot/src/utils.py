...
# ===== БЫСТРАЯ ПРОВЕРКА!!! =====
# =======================================
# В консоли (в папке ai_chat_bot) выполни команду:
# python -c "from src.utils import load_config; cfg = load_config(); print(cfg); log_action('Тест из консоли', cfg['log_file'])"