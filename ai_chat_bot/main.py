...
# Добавляем корень проекта в пути импорта, чтобы Python видел папку srd/
...
# Эта конструкция гарантирует, что main() запустится только при прямом запуске файла
